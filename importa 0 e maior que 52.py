...
FILTRO_ITEM_EXCEL = 'zero_and_greater_than_52' # Opção de filtro principal.
VALOR_REFERENCIA_FILTRO = 52 # Usado com 'greater_than_X' ou 'zero_and_greater_than_X'
...
def main() -> None:
    ...
    elif FILTRO_ITEM_EXCEL == 'zero_and_greater_than_52':
    ...
    elif isinstance(FILTRO_ITEM_EXCEL, list):
